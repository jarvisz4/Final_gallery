...
const carouselImages: MemoryImage[] = [
  {
    id: "1",
  ...
  {
    id: "8",
    src: "/elegant-gallery-couple.png",
    title: "Art & Culture",
...
export function InfiniteCarousel() {
  ...
  const tripleImages = [...carouselImages, ...carouselImages, ...carouselImages]
